...
//  Проверява дали методът връща 0.00, когато няма стоки в
//  касовата бележка. Уверява се, че не се начислява цена без артикули.
    @Test
    ...
    //Тества дали методът работи правилно и при null
    // вместо карта със стоки. Очаква се отново да върне 0.00 без грешка.
    @Test
    ...
    //Проверява дали при празна касова бележка се връща
    // съобщение с „ГРЕШКА“. Така се предупреждава потребителят за липсващи артикули.
    @Test
